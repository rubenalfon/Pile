 ...
 * Wraps Android's [PdfRenderer] API to provide clean access to page counts and bitmap rendering.
 */
class PdfRenderHelper(
     ...
     * @return The rendered [Bitmap], or null if failed.
     */
    ...
    /**
     * Opens a PDF file and returns a [Pair] of [PdfRenderer] and [ParcelFileDescriptor].
     *
     * @param file The source PDF file.
     * @return A [Pair] of [PdfRenderer] and [ParcelFileDescriptor].
     */
