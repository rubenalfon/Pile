...
class RemoveBitmapFromCacheUseCase(
     ...
     *
     * @param document The [com.ganadoro.pile.DocumentModel] containing the image.
    ...
    /**
     * Iterates through all available [com.ganadoro.pile.domain.models.ImageFilterType] and removes the cached
