...
/**
 * Use case responsible for providing a secure [android.net.Uri] of a document's PDF file for external use.
 *
...
class GetPdfUriUseCase(
    ...
    /**
     * Retrieves a shareable [android.net.Uri] for the given [document].
     *
     * @param document The document model to get the PDF URI for.
     * @return A secure content [android.net.Uri] pointing to a temporary copy of the PDF with its proper title.
     */
