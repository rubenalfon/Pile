 ...
 * fetched from [com.ganadoro.pile.domain.repositories.FileRepository.StorageType.CACHE] (for drafts) or [com.ganadoro.pile.domain.repositories.FileRepository.StorageType.PERSISTENT] (for saved documents),
 * and then requesting the [com.ganadoro.pile.domain.repositories.BitmapCacheRepository] to process and cache the resulting bitmap.
 */
class RequestDraftBitmapLoadUseCase(
     ...
     * 1. Determines the storage location based on the [com.ganadoro.pile.DocumentImage.isDraft] status.
