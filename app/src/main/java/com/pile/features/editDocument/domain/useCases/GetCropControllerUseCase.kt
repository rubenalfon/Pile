package com.pile.features.editDocument.domain.useCases
...
import com.pile.core.domain.models.ResizedBitmap
import com.pile.core.domain.repositories.FileRepository
import com.pile.features.editDocument.domain.models.ExtendedCropController
...
class GetCropControllerUseCase(
     ...
     * @param documentImage The [com.pile.DocumentImage] to load the crop controller for.
